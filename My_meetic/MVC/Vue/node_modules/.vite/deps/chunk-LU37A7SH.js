...
function useSlider(parameters) {
  ...
  const touchId = React3.useRef();
  const [active, setActive] = React3.useState(-1);
  const [open, setOpen] = React3.useState(-1);
  const [dragging, setDragging] = React3.useState(false);
  const moveCount = React3.useRef(0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React3.useState(-1);
  const sliderRef = React3.useRef();
  ...
  const previousIndex = React3.useRef();
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LU37A7SH.js.map
